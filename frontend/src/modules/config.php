...
function createDetailConfig($path) {
    ...
    if (file_exists($pathOrganisms)) {
        ...
        if (in_array("ParticipantFinished.vue", $organisms))
            $detailConfig['participantFinished'] = "output/ParticipantFinished";
...
$config['categorisation']['visualisation_master'] = ($config['common']['visualisation_master']);
