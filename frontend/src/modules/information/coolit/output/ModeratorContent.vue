<template>
  <div class="module-content">
          ...
          >
            ...
            >
              ...
              <template v-slot:footer>
                <AddItem
                  :text="$t('module.information.coolit.moderatorContent.add')"
                  :is-column="true"
    ...
    >
      <el-form-item
        :label="$t('module.information.coolit.moderatorContent.levelType')"
      ...
      >
        <el-select v-model="addIdea.parameter.type">
          <el-option
            ...
            :label="
              $t(
                `module.information.coolit.participant.placeables.${configType}.name`
              )
            "
          >
            <font-awesome-icon
      ...
      <el-form-item
        :label="$t('module.information.coolit.moderatorContent.share')"
        :prop="`parameter.shareData`"
      >
...
import LevelStatistic from '@/modules/information/coolit/organisms/LevelStatistic.vue';
import gameConfig from '@/modules/information/coolit/data/gameConfig.json';
import BuildState from '@/modules/information/coolit/organisms/BuildState.vue';
