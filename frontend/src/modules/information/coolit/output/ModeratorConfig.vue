<template>
  <el-form-item
    :label="$t('module.information.coolit.moderatorConfig.replayable')"
  ...
  <el-form-item
    :label="
      $t('module.information.coolit.moderatorConfig.showTutorialOnlyOnce')
    "
  ...
  <el-form-item
    :label="$t('module.information.coolit.moderatorConfig.mapSection')"
