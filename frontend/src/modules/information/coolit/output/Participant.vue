<template>
  <div ref="gameContainer" class="mapSpace">
    <module-info
      ...
      translation-path="module.information.coolit.participant.tutorial"
...
import SelectLevel from '@/modules/information/coolit/organisms/SelectLevel.vue';
import { TrackingManager } from '@/types/tracking/TrackingManager';
import * as cashService from '@/services/cash-service';
import TaskParticipantIterationStepStatesType from '@/types/enum/TaskParticipantIterationStepStatesType';
import PlayLevel from '@/modules/information/coolit/organisms/PlayLevel.vue';
import { ParticleState } from '@/modules/information/coolit/organisms/PlayLevel.vue';
