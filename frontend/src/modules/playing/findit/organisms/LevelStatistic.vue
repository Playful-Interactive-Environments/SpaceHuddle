...
export default class LevelStatistic extends Vue {
  ...
  calculateStarsChart(): void {
    if (this.steps) {
      ...
      this.barChartDataList.push({
        title: this.$t('module.playing.findit.statistic.rating'),
        data: {
          labels: labels,
          datasets: datasets,
        },
  ...
  calculateAvatarChart(gameStep: GameStep): void {
    if (this.steps) {
      ...
      this.barChartDataList.push({
        title: this.$t(`module.playing.findit.statistic.${gameStep}`),
        data: {
          labels: labels,
          datasets: datasets,
        },
  ...
  calculateTimeChart(): void {
    if (this.steps) {
      ...
      this.barChartDataList.push({
        title: this.$t('module.playing.findit.statistic.time'),
        data: {
          labels: labels,
          datasets: datasets,
        },
  ...
  calculateItemChart(gameStep: GameStep): void {
    if (this.steps) {
      ...
      this.barChartDataList.push({
        title: this.$t(`module.playing.findit.statistic.item.${gameStep}`),
        data: {
          labels: labels,
          datasets: datasets,
        },
  ...
  calculateItemCountChart(gameStep: GameStep): void {
    if (this.steps) {
      ...
      this.barChartDataList.push({
        title: this.$t(`module.playing.findit.statistic.itemCount.${gameStep}`),
        data: {
          labels: labels,
          datasets: datasets,
        },
