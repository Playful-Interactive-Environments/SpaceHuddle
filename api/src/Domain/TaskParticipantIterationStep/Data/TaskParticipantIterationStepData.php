...
namespace App\Domain\TaskParticipantIterationStep\Data;
 ...
 */
class TaskParticipantIterationStepData
{
    /**
     * The entity ID.
     * @var string|null
    ...
    /**
     * Step number within the current iteration.
     * @var int
     * @OA\Property()
     */
    public int $step;
    ...
    /**
     * The modified idea ID.
     * @var string|null
     * @OA\Property(example="uuid")
     */
    public ?string $ideaId = null;

    /**
     * Participant task state.
     * @var string|null
     * @OA\Property(ref="#/components/schemas/TaskParticipantIterationStepStateType")
     */
    public ?string $state;
