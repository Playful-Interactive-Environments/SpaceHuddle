 ...
 * )
 */
class TaskIdeaCreateAction
{
    use IdeaActionTrait;
    protected IdeaCreator $service;

    /**
     * The constructor.
     *
     * @param Responder $responder The responder
     * @param IdeaCreator $service The service
     */
    public function __construct(Responder $responder, IdeaCreator $service)
    {
