...
use App\Domain\Idea\Service\IdeaReader;
...
{
    use ActionTrait;
    protected IdeaReader $service;

    /**
     * The constructor.
     *
     * @param Responder $responder The responder
     * @param IdeaReader $service The service
     */
    public function __construct(Responder $responder, IdeaReader $service)
    {
